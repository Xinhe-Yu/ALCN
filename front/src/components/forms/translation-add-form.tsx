...
interface TranslationAddFormProps {
  entryId: string;
  entryName: string;
  onSave: (data: TranslationCreateData) => Promise<void>;
  onCancel: () => void;
}
...
export default function TranslationAddForm({ entryId, entryName, onSave, onCancel }: TranslationAddFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      success('Success', 'Translation added successfully');
      onCancel();
    } catch (err) {
      console.error('Failed to create translation:', err);
      error('Error', 'Failed to create translation');
    } finally {
      setIsSaving(false);
    }
  };
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Adding translation for: <span className="font-medium">{entryName}</span>
                  </p>
                </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <ul className="text-xs text-blue-800 space-y-1">
                          ...
                          <li>• Check existing translations to avoid duplicates</li>
                        </ul>
                      </div>
                    </div>
                  </>
